...
Direnv is an extension for your shell. It augments existing shells with a new feature that can load and unload [environment variables](environment-variables-in-linux.md) depending on the current directory.
